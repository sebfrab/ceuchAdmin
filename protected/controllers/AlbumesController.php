...
class AlbumesController extends Controller
{
	...
	{
		$model=new Albumes('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Albumes']))
			$model->attributes=$_GET['Albumes'];
	 ...
	 * @param Albumes $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='albumes-form')
		{
